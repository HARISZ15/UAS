...
<body id="dynamic-bg" class="bg-primary d-flex justify-content-center align-items-center vh-100">
    ...
    <script>
        ...
        const gradients = [
            ...
            'linear-gradient(45deg, #28a745, #a1ffce)',
            'linear-gradient(45deg, #ffc107, #ff9a76)',
            'linear-gradient(45deg, #17a2b8, #76e4ff)',
            'linear-gradient(45deg, #dc3545, #ff8a8a)',
        ];
        ...
        // Ubah warna setiap 3 detik
        setInterval(changeBackgroundGradient, 3000);
    </script>
